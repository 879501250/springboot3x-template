...
public class CodeGenerator {
    ...
    public static void getCode() {
        //TODO 修改为自己的数据库信息
        String url = "jdbc:mysql://localhost:3306/build?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai";
        String username = "root";
        String password = "abc4k321";
        //TODO 修改为自己的表名
        List<String> tables = List.of("function_system");//需要生成对应代码的表名的集合
